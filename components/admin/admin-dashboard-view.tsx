                    ...
                    <div className="animate-in fade-in slide-in-from-bottom-2 duration-500 max-w-7xl mx-auto">
                        ...
                        <div className="w-full bg-white dark:bg-stone-900 border border-stone-100 dark:border-stone-800 rounded-xl overflow-hidden shadow-[0_2px_20px_-5px_rgba(0,0,0,0.05)] min-h-[400px]">
                            {loading ? (
                                ...
                                <>
                                    {/* Desktop Header */}
                                    <div className="hidden lg:grid lg:grid-cols-[50px_120px_1fr_80px_120px_160px_130px_120px] gap-x-4 px-6 py-4 border-b border-stone-100 dark:border-stone-800 text-[9px] font-bold uppercase tracking-[0.2em] text-stone-400 bg-stone-50/50 dark:bg-stone-900/50 items-center">
                                    ...
                                    <div className="divide-y divide-stone-100 dark:divide-stone-800">
                                        {filteredInventory.map((product: Product) => (
                                            <div key={product.id} className="flex flex-col lg:grid lg:grid-cols-[50px_120px_1fr_80px_120px_160px_130px_120px] gap-x-4 items-center px-4 md:px-6 py-6 md:py-5 hover:bg-stone-50 dark:hover:bg-stone-800/30 transition-colors group relative">
